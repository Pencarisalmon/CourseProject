...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 left-[10rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
          ...
          {!userInfo && (
            <ul className="flex">
              ...
              <li>
                <Link
                  to="/register"
                  className="flex items-center mt-5 transition-transfrom transfrom hover:translate-x-2 ml-[1rem]"
                >
